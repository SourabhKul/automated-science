...
\begin{itemize}
    ...
    \item \textbf{Software Stack:} The current cleaned checkout records Python 3.14, JAX 0.9.2, Diffrax 0.7.2, and related packages in \texttt{requirements-freeze.txt}. Historical runs may have used earlier local environment states.
\end{itemize}
...
\bottomrule
\end{tabular}
\caption{Sensitivity analysis of the ABC-SMC engine on the Lotka-Volterra Ecology dataset. These small tests suggest that initial particle count materially affects fit quality, but they should be treated as a smoke test rather than a full sampler study.}
