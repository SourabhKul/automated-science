...
from real_warfarin_pkpd_data_loader import DEFAULT_FIXTURE, generate_data, resolve_raw_path
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert payload["diagnostics"]["residual_summary"]["global"]["observed_count"] == 12
