...
This project is an autonomous white-box scientific discovery system.

The premise is intentionally narrow and powerful: hold the observed data fixed, then automate the scientific loop of proposing explanatory model structures, fitting their parameters, diagnosing their failures, and replacing them with better white-box models.
...
This is the layer that turns repeated runs into a better scientist.
...
The May-June qwen36 run is the strongest proof-of-life artifact:
...
- LLM-generated white-box model replacement plus ABC-SMC fitting can discover useful structures across many scientific domains.
