...
particle_map = {
    ...
    "agriculture": 150000,
    "social": 150000,
    "real_sunspots": 150000,
    "real_nile": 150000,
    "real_macro": 150000,
    "real_theophylline": 150000,
    "real_co2": 150000,
}

def patch_orchestrators():
    print("Configurations are centrally managed in core/domain_configs.py. Stubs are active.")

MASTER_SCHEDULER = """import os
import subprocess
import shutil
...
if __name__ == "__main__":
    ...
    with open("master_scheduler.py", "w") as f:
        f.write(MASTER_SCHEDULER)
    print("Generated master_scheduler.py")
