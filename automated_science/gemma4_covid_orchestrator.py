...
# Load "google/gemma-4-26b-a4b" in LM Studio before running.
# ============================================================
LLM_ENDPOINT = "http://localhost:1234/v1/chat/completions"
MODEL_ID      = "google/gemma-4-26b-a4b"
RUN_SEED      = int(os.environ["E3_SEED"]) if os.environ.get("E3_SEED") else None
EXPERIMENT_TAG = "gemma4_covid"  # used to namespace all outputs
...
def run_loop():
    print("=" * 70)
    print(f"  GEMMA-4 26B  ·  COVID SEIRD Recursive Scientist")
