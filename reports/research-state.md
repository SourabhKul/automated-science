...
5. Keep raw smoke artifacts, local environments, and secrets out of Git; the earlier reviewed smoke report, state, and replay harness remain synchronized on `origin/main` at `f2ee1cc1e0a95ea8c3bd9ac9aacc725c76ae72d8`. This reference milestone is approved for the designated single-owner synchronization step.
